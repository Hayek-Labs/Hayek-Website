...
const Banner = () => {
  useEffect(() => {
    ...
    (function initThree() {
      ...
      webgl.texturesOptions = [
        ...
        },
        {
          ...
          texture: 'image',
          quote:
            'Someday I will <span style="color:#c89c5b">go</span> far away!',
          threshold: 30,
          random: 2.0,
          depth: 4.0,
          size: 1.5,
    ...
    function animate() {
      webgl.particlesMesh.material.uniforms.uTime.value +=
        webgl.clock.getDelta();
  ...
  return (
    <div className={styles.banner}>
      <div id="wrapper">
        ...
        <p className="clickInfo">click anywhere to start journey</p>
